...
<head>
  ...
  <meta property="og:type" content="website"><!-- トップページを意味する -->
  ...
  <!-- slickの読み込み -->
  <link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick-theme.css"><!-- 重要 -->
  <link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.css"><!-- 重要 -->
  <!-- jQuery読み込み -->
    ...
    <header class="pc-2">
      <nav>
        ...
        <div class="set-1">
          <div class="nav-set">
            <ul class="flex">
              <li><a href="#Access"><p class="f-14">アクセス</p></a></li>
            ...
            <ul class="flex nav-link">
              <li><a href="#Concept"><p class="f-20 f7">CONCEPT</p><p class="f-14">コンセプト</p></a></li>
              <li><a href="#Facility_Guide"><p class="f-20 f7">FACILITY GUIDE</p><p class="f-14">施設案内</p></a></li>
              <li><a href="#Floor_maps"><p class="f-20 f7">FLOOR MAPS</p><p class="f-14">フロアマップ</p></a></li>
              <li><a href="#Price"><p class="f-20 f7">PRICE</p><p class="f-14">料金</p></a></li>
              <li><a href="#Flow"><p class="f-20 f7">FLOW</p><p class="f-14">入会の流れ</p></a></li>
            </ul>
          </div>
